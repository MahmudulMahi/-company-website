...
const Solutionsecton = () => {
  return (
    <>
      <div className='flex flex-col md:flex-row mt-20 gap-20 mx-auto  justify-center'>
        <div className='relative'>

          <img className="rounded-2xl" style={{ width: '500px', height: '440px' }} src={bgrec1} alt="" />
          <div className='absolute top-8 -right-8 '>
            <img className="rounded-2xl" style={{ width: '500px', height: '440px' }} src={solutionimg} alt="" />
          </div>
        ...
        <div>
          ...
          <div className="relative mt-8">
            ...
            <div className="absolute w-[350px] md:w-[450px] top-0 md:top-8 left-11  md:left-20">
            <span className='block mb-0 md:mb-4 '>
